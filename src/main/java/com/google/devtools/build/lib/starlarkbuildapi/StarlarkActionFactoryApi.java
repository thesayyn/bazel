  ...
  @StarlarkMethod(
      ...
      doc =
          "Creates an action that makes <code>target_file</code>'s content available at"
              ...
              + " the content is materialized is chosen by the execution strategy that stages it, the"
              + " same way input laydown is chosen today. Strategies that cannot materialize content"
              + " (a purely symlinking sandbox, or non-sandboxed local execution) do not honor this;"
